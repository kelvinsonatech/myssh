...
- [Installer phase isolation](installer-phase-isolation.md) — optional package/service failures must warn and continue; finish with a health pass that retries only inactive core services.
